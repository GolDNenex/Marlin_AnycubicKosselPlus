...
#define CONFIGURATION_H_VERSION 010107 //Marlin 1.1.7/8
...
#define DELTA
  ...
  #define DELTA_CALIBRATION_RADIUS DELTA_PRINTABLE_RADIUS*0.750 // mm
  ...
  #define DELTA_RADIUS 132.44 //mm  Get this value from auto calibrate
...
#define STRING_CONFIG_H_AUTHOR "(Nenex, linear plus)" // Who made the changes.
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -19     // Z offset: -below +above  [the nozzle]
...
// Invert the stepper direction. Change (or reverse the motor connector) if an axis goes the wrong way.
  #define INVERT_X_DIR true //inverser pour les tmc2208 | default = true
  #define INVERT_Y_DIR true
  #define INVERT_Z_DIR true
/*#ifdef HAVE_TMC2208
  #define INVERT_X_DIR true//inverser pour les tmc2208
  #define INVERT_Y_DIR true
  #define INVERT_Z_DIR true
#else
...
#define INVERT_E0_DIR true // default = true
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_Z_FEEDRATE 60      // Z axis feedrate in mm/s (not used for delta printers)
#endif
