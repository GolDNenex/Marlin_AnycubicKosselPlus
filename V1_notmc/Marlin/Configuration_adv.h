...
//  #define USER_SCRIPT_AUDIBLE_FEEDBACK
  ...
  #define USER_DESC_1 "Home & level"
  #define USER_GCODE_1 "G28\nG29\nM117 Home & level Done"                                       /*"M140 S180" STRINGIFY(PREHEAT_2_TEMP_BED)*/ /*"\nM104 S70" STRINGIFY(PREHEAT_2_TEMP_HOTEND)*/
 
  #define USER_DESC_2 "Home & Stat"
  #define USER_GCODE_2 "G28\nM78\nM117 Home & Stat Done"

  #define USER_DESC_3 "Home & steppers off"
  #define USER_GCODE_3 "G28\nM84\nM117 Home & Step off Done"/* STRINGIFY(PREHEAT_1_TEMP_HOTEND)*/
  
  #define USER_DESC_4 "Extruder 15mm de PLA"
  #define USER_GCODE_4 "M140 S70\nM104 S180\nG91 E15 F300\nG92 E0\nG1 E-1 F300\nM117 Extrude  Done" //chauffe,extrude 15mm de pla et retract 1mm

  #define USER_DESC_5 "Changer de filament"
  #define USER_GCODE_5 "M600"                                                 /*"M140 S" STRINGIFY(PREHEAT_2_TEMP_BED) "\nG28\nG29"*/
